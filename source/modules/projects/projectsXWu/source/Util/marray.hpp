...
namespace marray_detail {
    ...
    template<class A> inline void Assert(A assertion) {
        if(!assertion)
            throw std::runtime_error("marray: Assertion failed.");
    }
...
/// Get a constant iterator to the beginning of the shape std::vector.
///
/// \return iterator.
/// \sa shapeEnd()
///
...
/// Get a constant iterator to the end of the shape std::vector.
///
/// \return iterator.
/// \sa shapeBegin()
///
...
/// Get a constant iterator to the beginning of the strides std::vector.
///
/// \return iterator.
/// \sa stridesEnd()
///
...
/// Get a constant iterator to the end of the strides std::vector.
///
/// \return iterator.
/// \sa stridesBegin()
///
...
/// instance address all odd elements in a std::vector while the current
